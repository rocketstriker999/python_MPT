...
while True:
    ...
    if c=='1':
        ...
        if choice=='1' :
            os.chdir('web/header/')
            os.system('header_getter.py')
        
        elif choice=='2' :
            os.chdir('web/ipfetcher/')
            os.system('ipadress.py')
        
        elif choice=='3' :
            os.chdir('web/dorklist')
            os.system('starter.py')
        
        elif choice=='4':
            os.chdir('web/dictonarymaker')
            os.system('dictonarymaker.py')
            ...
            os.system('email_bomb.pyc')
        
        elif choice=='7':
            os.chdir('web/ddos/')
            os.system('request_flooder.py')
        
        elif choice=='8':
            os.chdir('web/proxylisttester/')
            os.system('proxy_list_tester.py')
        
        elif choice=='9':
            os.chdir('web/crawler')
            os.system('input_taker.py')
        
        elif choice=='10':
            os.chdir('web/hashmaker')
            os.system('hashgen.py')
            ...
            os.system('ftpcracker.py')
        
        elif choice=='13':
            os.chdir('web/smtpcracker/')
            os.system('smtpcracker.py')
            ...
            os.system('adminpanel_finder.py')
        
        elif choice=='16':
            os.chdir('web/fiscanner/')
            os.system('lfi_scanner.pl')
            ...
            os.system('whole_server_sqli.py')
        ...
        if cn=='1':
            ...
            os.system('lanscanner.py')

        elif cn=='2':
            os.chdir('network/routercracker/')
            os.system('routercracker.py')
        ...
        print"\t\t\t#                              #"
        print"\t\t\t################################"
        print"\n[+]PRESS 1 FOR COMPUTER SECURITY TESTING..."
        print"\n[+]PRESS 2 FOR RAR OR ZIP PASSWORD CRACKER..."
        print"\n[+]PRESS 3 WINDOWS PASSWORD PASSWORD CRACKER..."
        cc=raw_input("\n\n[+]PLEASE ENTER YOUR CHOICE :")

        if cc=='1':
            os.chdir("computer/emailkeylogger/")
            ...
            os.system('rarp.py')
              ...
              os.chdir("computer\windows_pass_crack")
              os.system('windows_pass_cracker.py')
