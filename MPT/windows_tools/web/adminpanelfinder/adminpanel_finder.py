...
print "\n\t\t#################################################"
print "\t\t#                                               #"
print "\t\t#            ADMIN PANEL FINDER UTILITY         #"
print "\t\t#                   BY WARLOCK                  #"
print "\t\t#                                               #"
print "\t\t#################################################"
try:
...
def write():
    ...
    name = 'admin'+'.txt'  # Name of text file coerced with +.txt
...
keyword = ['admin.php','administrator/','login.php','phpmyadmin','admin1/','admin2/','admin.php','admin3/','admin4/','admin5/','usuarios/','usuario/','administrator/','moderator/','webadmin/','adminarea/','bb-admin/','adminLogin/','admin_area/','panel-administracion/','instadmin/',
...
'adm/index.cfm','adm.cfm','affiliate.cfm','adm_auth.cfm','memberadmin.cfm','administratorlogin.cfm''admin/','administrator/','admin1/','admin2/','admin3/','admin4/','admin5/','moderator/','webadmin/','adminarea/','bb-admin/','adminLogin/','admin_area/','panel-administracion/','instadmin/',
...
'adm/index.brf','adm.brf','affiliate.brf','adm_auth.brf','memberadmin.brf','administratorlogin.brf''admin/','phpmyadmin','administrator/','admin1/','admin2/','admin3/','admin4/','admin5/','usuarios/','usuario/','administrator/','moderator/','webadmin/','adminarea/','bb-admin/','adminLogin/','admin_area/','panel-administracion/','instadmin/',
...
'adm/index.php','adm.php','affiliate.php','adm_auth.php','memberadmin.php','administratorlogin.php''admin/','administrator/','admin1/','admin2/','admin3/','admin4/','admin5/','usuarios/','usuario/','administrator/','moderator/','webadmin/','adminarea/','bb-admin/','adminLogin/','admin_area/','panel-administracion/','instadmin/',
...
site = raw_input("\n[+]Enter URL or IP(e.g. http://site.com or 11.112.21.11) : ")
site = site.replace("http://","")
print ("\tCHECKING THIS :" + site + "...")
try:
...
for admin in keyword:
    ...
    if response.status == 200:
        var1 = var1 + 1
        print "%s %s" % ( "[+]"+host,"ADMIN PAGE FOUND")
        ...
        print "%s %s" % ("\n>>>" + host, "[+]POSSIBLE ADMIN PAGE (403 - Redirect)")
...
f = open("admin.txt","r")
contents = f.read()
print "\n\n[+]AS PER MY RESULT :",contents
f.close()

print"\n\n[-]REMOVING LOGS PLEASE WAIT!!!"
os.remove('admin.txt')
time.sleep(3) # delays for 3 seconds


print"\n[+]DID I FIND ADMIN PAGE OF YOUR WEBSITE???"
o=raw_input("y or n : ")
...
if o=='y':
  ...
  v=raw_input("y or n : ")
  if v=='y':
    print"\n[+]STEP 1.  MAKE A UNCOMMON URL FOR ADMIN PAGES"
    print"\n[+]STEP 2.  MAKE YOUR DATABASE TO READ ONLY"
    print"\n[+]STEP 3.  KEEP STRONGER PASSWORD AND UNCOMMON USERNAME"
